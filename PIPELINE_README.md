...
- Implemented:
  ...
  - `09_features.smk`: optionally runs external BLASTP annotation and Pfam hmmscan, enriches query annotations from orthogroup consensus labels, and writes a query-centered feature follow-up note
